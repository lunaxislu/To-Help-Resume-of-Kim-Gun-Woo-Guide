...
const ProductsWriteForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      >
        <h2 style={{ fontSize: '20px', fontWeight: 'bold', width: '200px' }}>
          제목*
        </h2>
        <input
          type="text"
      ...
      >
        <h2
          style={{ fontSize: '20px', fontWeight: 'bold', width: '200px' }}
        ></h2>
      ...
      >
        ...
        <input
          ...
          disabled={
            getValues('deal_type') === '택배' ||
            getValues('deal_type') === '협의 후 결정'
          }
          ...
          {quality.map((quality, idx) => (
            <label key={idx} htmlFor={quality.condition}>
              <input
                ...
                value={quality.condition}
                {...register('quality', {
                  required: '상품상태를 선택해주세요.'
                })}
              />
              {quality.condition}
            </label>
      ...
      <div style={{ backgroundColor: 'lightgrey', padding: '15px' }}>
        ...
        <label htmlFor="agreement">
          <input
            ...
            {...register('agreement', {
              required:
                '주의사항에 동의를 해주셔야 중고거래 게시물을 등록할 수 있습니다.'
            })}
          />
          동의합니다.
        </label>
