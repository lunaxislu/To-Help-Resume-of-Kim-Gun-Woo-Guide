...
const ProductsList = () => {
  ...
  const [postsPerPage, setPostsPerPage] = useState<number>(PAGE_POST_NUMBER);
...
//  if(isLoading) {<div>로딩중</div>}
  ...
  return ( <div></div>
    ...
    //     </St.SearchBarContainer> */}
    //   </St.BarContainer>
    //     {/* <ProductListCard currentPosts={currentPosts} selectCategory={selectCategory} clickedCategory={clicked} />
    //     <Pagination totalPosts={productsPosts?.length} postsPerPage={postsPerPage} currentPage={currentPage} setCurrentPage={setCurrentPage} selectCategory={selectCategory} /> */}
    //   </St.ContentsContainer>
    // </St.EntireContainer>
  );
};
